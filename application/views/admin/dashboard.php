                ...
                <div class="block-content">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <a href="<?php echo base_url('manage-brands'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                     ...
                     <a href="<?php echo base_url('add-brand'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                ...
                <div class="block-content">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <a href="<?php echo base_url('manage-models'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                     ...
                     <a href="<?php echo base_url('add-model'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                ...
                <div class="block-content">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <a href="<?php echo base_url('manage-access') ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                     ...
                     <a href="<?php echo base_url('add-access');?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                ...
                <div class="block-content">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <a href="<?php echo base_url('update-tax'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                     ...
                     <a href="<?php echo base_url('manage-orders'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                ...
                <div class="block-content">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <a href="<?php echo base_url('manage-users'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
                     ...
                     <a href="<?php echo base_url('add-user'); ?>"> <div class="block-content block-content-full block-content-mini bg-primary text-white push-15 ">
