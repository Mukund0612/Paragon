        ...
        <div class="sidebar-content">
            ...
            <div class="side-header side-content bg-white-op">
              ...
              <div class="btn-group pull-right">
                ...
                <a class="h5 text-white" href="<?php echo base_url();?>admin/">

					<img src="<?php echo base_url();?>assets/user/images/logo.png" style="width:187px;"/>
					<?php // echo $SITE_URL."images/logo.png";die(); ?>
