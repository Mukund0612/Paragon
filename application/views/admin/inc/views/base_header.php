...
<header id="header-navbar" class="content-mini content-mini-full">
    ...
    <ul class="nav-header pull-right">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li>
                        ...
                        <a tabindex="" href="<?php echo base_url('setting'); ?>">
                    ...
                    <li>
                        ...
                        <a tabindex="-1" href="<?php echo base_url('logout'); ?>">
        ...
        <li>
            ...
            <?php /*?><button class="btn btn-default" data-toggle="layout" data-action="side_overlay_toggle" type="button">
