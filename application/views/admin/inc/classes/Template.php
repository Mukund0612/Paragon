...
class Template {
    ...
    private function build_nav_array($nav_array) {
        ...
        foreach ($nav_array as $node) {
            ...
            // echo "<pre>"; print_r($node['sub']);

            $link_type      = isset($node['type']) ? isset($node['type']) : '';
            // echo $node['type']."<br>";

            $sub_active     = false;
            // echo $node['sub_active']."<br>";
    ...
    public function get_label($print = true) {
        ...
        $data   = array(
            ...
            '0' => array('class' => 'success', 'text'  => 'Completo'),

            '1' => array('class' => 'info', 'text'  => 'Procesando'),

            '2' => array('class' => 'primary', 'text'  => 'Pendiente'),

            '3' => array('class' => 'warning', 'text'  => 'Cancelado'),
	...
	public function get_pro_status($print = true) {
        ...
        $data   = array(
            ...
            '3' => array('class' => 'danger', 'text'  => 'Cancelado')
	  ...
	  public function get_manager($print = true) {
	 ...
	 public function get_manager_roll($print = true) {

	 

	 	  $data   = array(

            '0' => array( 'text'  => 'Support'),

            '1' => array('text'  => 'Developer'),

            '2' => array('text'  => 'Designer'),

            '3' => array( 'text'  => 'Tester'),

			 '4' => array('text'  => 'Superviser'),
	  ...
	  public function get_package($print = true) {

	 

	 	  $data   = array(

            '0' => array( 'text'  => 'WEBMASTER'),

            '1' => array('text'  => 'PRINCIPIANTE'),

            '2' => array('text'  => 'A MEDIDA')
