...
$one->assets_folder					= base_url().'assets/admin/';
...
$one->body_bg                      = base_url().'assets/admin/img/photos/photo15@2x.jpg';       // eg 'assets/img/photos/photo10@2x.jpg' Useful for login/lockscreen pages
...
$one->main_nav                     = array(
	...
	array(
        ...
        'icon'  => 'si si-users',
      	...
      	'url'	=>	base_url('manage-subscribers')	
