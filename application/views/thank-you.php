                    ...
                    <div class="row">                    	
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="heading-content">
                                ...
                                <span><a href="<?php echo base_url(); ?>">Home</a> / Thank you</span>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                        	...
                        	<?php if($success != ''){
								echo "<h1 style='line-height:48px;' >Thank you for shopping with us. <br />Your transaction is successful. <br /> Your transaction id is <strong>".$success."</strong> <br />We will be shipping your order to you soon.</h1>";
							}else{
