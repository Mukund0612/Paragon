                    ...
                    <div class="row">                    	
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>Brands</h2>
                                <span><a href="<?php echo base_url();?>">Home</a> / Brands</span>
                            </div>
                        </div>
                ...
                <div class="container">
						...
						<div class="row" >
							<div class="col-md-12 col-sm-12 col-xs-12 brand_main">
								<?php foreach ($brands_all as $brand_all ) {  
									// id store in array
									// print_r($brand_all);
									// die();
								?>
									...
									<div class="col-md-4 col-sm-6 mix brands-item ">       
										<div class="portfolio-wrapper">                
											<div class="brand-thumb">
												<a href="<?php echo base_url('brand'); ?>/<?php echo $brand_all->slug; ?>"><img src="<?php echo $brand_all->brand_image; ?>" alt="Hero" class="model_img"/></a>
											</div>  
                                            <h3><?php echo $brand_all->brand_name; ?></h3>
										</div>          
									</div>
								<?php } ?>
							</div>
