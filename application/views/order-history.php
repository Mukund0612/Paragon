                               ...
                               ?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <span class='label label label-success'>Complete</span>
                                  	<?php
								  //  switch('C')
                                  ...
                                  <td><?php echo date('d/m/Y',strtotime($row_orders->u_order_date)) ?></td>

                              

                                  <td>Rs. <?php echo $row_orders->amount; ?></td>

                                  <td><a href="<?php echo base_url('invoices'); ?>/<?php echo $row_orders->order_id; ?>.pdf">Download Invoice</a></td>
