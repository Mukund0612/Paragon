...
<?php /*?><div class="loadvideo" style="width: :100%;">
    ...
    <video id="my-video" class="video-js vjs-big-play-centered hidden-xs hidden-sm" muted autoplay preload="auto" style="width:100%;top: 25%;position: relative;"
          ...
          data-setup='{}'><source src="<?php echo base_url(); ?>images/logo.mp4">
...
<?php // print_r($access_left);die(); ?>
  <div id="slider">
        ...
        <ul class="jis-trigger">
          <li class="jis-selected" ><img src="<?php echo base_url(); ?>assets/user/images/ParagonBanner1.jpg" alt="" /> </li>
  ...
  <div class="product-slider-section">
    <div class="container">
      <div class="heading-section">
        ...
        <a href="<?php echo base_url('brand'); ?>/<?php echo $brands_view[0]->brand_name; ?>" class="view-all">View All</a> </div>
      <div class="row">
          ...
          <div class="portfolio-wrapper">
            <div class="portfolio-thumb"> 
              ...
              <a href="<?php echo base_url('product'); ?>/<?php echo $acc_letf->slug; ?>">
                <div class="badge_discount" ><span><?php echo $acc_letf->a_discount; ?>% <small>Off</small></span></div>
              <!-- Image Display -->
              <?php if($acc_letf->a_picture != "") { ?>
              <img src="<?php echo $acc_letf->a_picture; ?>" alt="<?php echo $acc_letf->a_name; ?>" class="model_img"/>
            <?php } ?>
              </a>
            </div>
            <!-- Name -->
            <h3><h3><?php echo $acc_letf->a_name; ?></h3></h3>
            <!-- Price -->
            ...
            <p><a href="javascript:;" data-id="<?php echo $acc_letf->id; ?>" data-price="<?php echo $acc_letf->a_price; ?>" class="add-to-cart-btn add_to_cart">Add to Cart</a></p>
          </div>
        </div>
      <?php } ?>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12 download-pdf">
        	<a href="<?php echo base_url(); ?>assets/user/images/paragon-accessories-booklet.pdf" download><img src="<?php echo base_url(); ?>assets/user/images/pdf.png" alt="Download Booklate" title="Download Booklate"/></a>
        </div>
