...
<style type="text/css" >
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" ><img src="<?php echo base_url(); ?>assets/user/images/free-delivery2.gif" alt="Free Home Delivery" title="Free Home Delivery" class="free-delivery" /></div>
		<a href="<?php echo base_url(); ?>cart/" class="cls_cart_stk" >Your Cart (<?php echo count($_SESSION['cart']['item_id']) ?>)</a>
		
		<?php
		$cart = $_SESSION['cart'];
		$sub_total  = 0;
		$wh_tax['id'] = 1;
		$GST_per = $this->Paramodel->get_one('tax','tax_per',$wh_tax);
