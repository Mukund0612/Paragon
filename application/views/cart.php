        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img class="increase" src="<?php echo base_url(); ?>assets/user/images/plus.png"
                                        alt="Increase" title="Increase" width="24" style="cursor: pointer;"
                                        data-id="<?php echo $cart['item_id'][$i]; ?>">
                                    <input min="1" type="number" name="" class="qty"
                                        value="<?php echo $cart['item_qty'][$i]; ?>" />
                                    <img class="descrease" src="<?php echo base_url(); ?>assets/user/images/minus.png"
                                        alt="Descrease" title="Descrease" width="24" style="cursor: pointer;"
                                        data-id="<?php echo $cart['item_id'][$i] ?>">

                                    <a href="javascript:;" class="update_qty"
                                        data-id="<?php echo $cart['item_id'][$i] ?>" alt="Update" title="Update"><img
                                            src="<?php echo base_url(); ?>assets/user/images/refresh.png" alt="Update"
                                            title="Update"></a>
                                ...
                                <td><a href="javascript:;" class="delete_item"
                                        data-id="<?php echo $cart['item_id'][$i] ?>">Remove</a></td>
                ...
                <div class="col-md-4" style="float:right">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h3>Rs. <?php echo number_format($total_of_cart, 2); ?></h3>
                                </td>
                    ...
                    <div class="send" align="center"><button type="button" id='btn_ckeckout' style="width: 100%"
                            onclick="javascript:window.location.href='<?php echo base_url('checkout'); ?>/'">Proceed to
                            Checkout</button>
                        <br />
